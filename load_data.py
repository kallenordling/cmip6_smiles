...
df = df[ (df.table_id.isin(['day','Amon'])) & (df.variable_id.isin(['tasmax','tas'])) & df.experiment_id.isin(['historical','ssp129','ssp119','ssp245','ssp370']) & df.activity_id.isin(['CMIP','ScenarioMIP'])]
...
gmst_dicts = {}
print('calc means')
for exp, dic in tqdm(results.items()):
	tmp = {}
